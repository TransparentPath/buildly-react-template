...
export const NAVIGATION_ITEMS = [
  {
    ...
    name: 'Shipments', // Display name for the shipment menu item
  ...
  },
  {
    ...
    name: 'Items', // Display name for the items menu item
  ...
  },
  {
    ...
    name: 'Custodians', // Display name for the custodians menu item
  ...
  },
  {
    ...
    name: 'Trackers', // Display name for the trackers menu item
  ...
  },
  {
    ...
    name: 'Reporting', // Display name for the reporting menu item
