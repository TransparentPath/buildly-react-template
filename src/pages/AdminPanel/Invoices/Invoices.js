...
const Invoices = () => {
  ...
  const { data: whatsappChargesData, mutate: whatsappChargesMutation, isLoading: isWhatsappChargesLoading } = useWhatsappChargesMutation(displayAlert, 'Invoices');

  const { mutate: editTrackerOrderMutation, isLoading: isTrackerOrderEditing } = useEditTrackerOrderMutation(org_uuid, displayAlert, 'Invoices');
