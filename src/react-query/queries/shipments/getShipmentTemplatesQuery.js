 ...
 */
export const getShipmentTemplatesQuery = async (organization, displayAlert, section) => {
  try {
    ...
    getErrorMessage(section, error, 'load shipment template(s) data', displayAlert);
