...
import { useMutation, useQueryClient } from 'react-query'; // React Query's `useMutation` hook for handling mutations
 ...
 */
export const useFetchNewGatewayMutation = (displayAlert, section) => {
