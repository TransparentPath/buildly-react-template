 ...
 */
export const useAddGatewayTypeMutation = (history, redirectTo, displayAlert, section) => {
  ...
  return useMutation(
    ...
    },
    {
      ...
      onSuccess: async () => {
        ...
        displayAlert('success', i18n.t('api.successMessages.Successfully added tracker type'));
      ...
      onError: (error) => {
        ...
        getErrorMessage(section, error, 'create tracker type', displayAlert);
      },
    },
  );
};
